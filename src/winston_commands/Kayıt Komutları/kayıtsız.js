...
module.exports = {
    ...
    execute: async (client, message, args, winston_embed) => {
        ...
        await message.guild.members.cache.get(member.id).setNickname(`${winston_config.kayitsizHesapIsim}`);
        ...
        message.reply({ embeds: [winston_embed.setDescription(`> **${member} Kullanıcısı Başarıyla Kayıtsıza Atıldı!**`)] })
